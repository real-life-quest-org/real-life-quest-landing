  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-12">
          <h1 className="section-title section-title-blue mb-4 text-center text-sm md:text-lg">
            プライバシーポリシー
          </h1>
        ...
        <div className="border-4 border-[var(--text-green)] bg-black/80 p-8 space-y-8 rlq-card">
          <section>
            <h2 className="text-lg font-bold text-[var(--text-green)] mb-4">第1条（個人情報の定義）</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--action-red)] mb-4">第2条（個人情報の収集）</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--player-blue)] mb-4">第3条（個人情報の利用目的）</h2>
            <p className="text-sm text-gray-300 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--player-blue)] mb-4">第4条（個人情報の第三者提供）</h2>
            <p className="text-sm text-gray-300 leading-relaxed">
              運営者は、以下のいずれかに該当する場合を除き、あらかじめユーザーの同意を得ることなく、第三者に個人情報を提供することはありません。
            </p>
            <ul className="list-disc list-inside text-sm text-gray-300 space-y-2 ml-4 mt-3">
              <li>法令に基づく場合</li>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--text-green)] mb-4">第5条（個人情報の安全管理）</h2>
            <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--action-red)] mb-4">第6条（Cookieの使用について）</h2>
            <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--player-blue)] mb-4">第7条（プライバシーポリシーの変更）</h2>
            <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--player-blue)] mb-4">第8条（お問い合わせ窓口）</h2>
            <p className="text-sm text-gray-300 leading-relaxed">
